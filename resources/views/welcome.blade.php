<x-guest>
    ...
    <div
        class="mt-8 pt-4 border-t border-gray-100 dark:border-gray-800 text-center text-xs text-gray-400 dark:text-gray-500">
        &copy; {{ date('Y') }} {{ config('app.name') }}. {{ __('ui.footer.rights_reserved') }}
    </div>
</x-guest>
