<x-guest>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Имя -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('ui.fields.name') }}</label>
        ...
        <!-- Email -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('ui.fields.email') }}</label>
        ...
        <!-- Пароль -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('ui.fields.password') }}</label>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('ui.fields.password_confirmation') }}</label>
    ...
    <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800 text-center text-sm">
        <span class="text-gray-500 dark:text-gray-400">{{ __('ui.auth.already_registered') }}</span>
